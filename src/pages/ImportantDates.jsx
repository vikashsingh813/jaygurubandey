    ...
    <div className="important-dates-container">
      ...
      <div className="content-section bottom">
        <div className="dates-box">
          <p>
            🔔 <strong>छितौना धाम, वाराणसी (मुख्यालय)</strong> – हर महीने <strong>1, 2, 15, 16, 25 और 26</strong><br />
          ...
          <p>
            📅 <strong>नगवां आश्रम (गाजीपुर)</strong> – हर महीने <strong>4 और 19</strong><br />
            📞 संपर्क: 7080224203
          </p>
          ...
          <p>
            📅 <strong>शिवरामपुर (श्री गिरजा प्रसाद यादव जी के निवास पर)</strong> – हर महीने <strong>27</strong><br />
            📞 संपर्क: 8738868292
          </p>

          <p>
            📅 <strong>सीधागर घाट आश्रम (गाजीपुर)</strong> – हर महीने <strong>23</strong><br />
